...
def process_nlp(wit_response):
    ...
    elif intents[0]['value'] == 'event_search':

        event_list = []
        graph = facebook.GraphAPI(access_token="EAAVWYdbX2BUBAJZBmlbIeZCoocO5CdRHY82VNs8drNbB0yNL5bj63K0ZCQqIqzAbrl0u2ollXrsFIiRMfebWAQmpF1sw2EsThg1TpDulsygqGkQQ7dcHZCZB6W6QGlejXKYEg0ObqZAOTXGqKe9exLf57ZCQW546Kh5W66lEOvaGjX3ffruHXXT",
                          version="2.7")

        city = geocoder.google([35.188,-111.653], method='reverse')

        # place = input('What would you like to search for? \n')
